...
label variable ECLWRK1 "JB: Class of worker";
label variable ECLWRK2 "JB: Class of worker";
...
label variable TEBDATE1 "BS: Date operation of business ended";
label variable TEBDATE2 "BS: Date operation of business ended";
label variable TJBOCC1 "JB: Occupation classification code";
label variable TJBOCC2 "JB: Occupational classification code";
label variable TSBDATE1 "BS: Date operation of business began";
label variable TSBDATE2 "BS: Date operation of business began";
...
label variable RFID2 "FA: Family ID excluding related subfamily members";
...
label variable ECNTRC2 "JB: Coverage by union or something like a union contract";
...
label variable EUECTYP6 "GI: Receipt of Supplemental Unemployment Benefits";
label variable SSUID "SU: Sample Unit Identifier";
label values TSJDATE1 FM0X;
label values EJBHRS1 FM1X;
label values TPYRATE1 FM2X;
label values TSJDATE2 FM3X;
label values EJBHRS2 FM4X;
label values TEJDATE1 FM5X;
label values TEJDATE2 FM6X;
label values TFIPSST FM7X;
label values ECLWRK1 FM8X;
label values ECLWRK2 FM9X;
label values EEDUCATE FM10X;
label values TEBDATE1 FM13X;
label values TEBDATE2 FM14X;
label values TJBOCC1 FM15X;
label values TJBOCC2 FM16X;
label values TSBDATE1 FM17X;
label values TSBDATE2 FM18X;
label values EUECTYP5 FM19X;
label values ER05 FM20X;
label values ER06 FM21X;
label values RFID2 FM23X;
label values RHTYPE FM24X;
label values SREFMON FM25X;
label values RPYPER1 FM26X;
label values RPYPER2 FM27X;
label values RWCMPRSN FM28X;
label values T05AMT FM29X;
label values T10AMT FM30X;
label values T15AMT FM31X;
label values TMTHRNT FM35X;
label values TPMSUM1 FM36X;
label values TPMSUM2 FM37X;
label values TPYRATE2 FM38X;
label values TMIOWN FM39X;
label values ECNTRC1 FM42X;
label values ECNTRC2 FM43X;
label values EENO1 FM44X;
label values EENO2 FM45X;
label values EJBIND1 FM46X;
label values EJBIND2 FM47X;
label values ELMPTYP2 FM48X;
label values ELMPTYP3 FM49X;
label values EMRTJNT FM50X;
label values EMRTOWN FM51X;
label values ERSEND1 FM52X;
label values ERSEND2 FM53X;
label values ESTLEMP1 FM54X;
label values ESTLEMP2 FM55X;
label values ETENURE FM56X;
label values EUECTYP6 FM57X;
...
label variable LGTKEY "PE: Person longitudinal key";
label variable EBMNTH "PE: Month of birth";
label variable TBYEAR "PE: Year of birth";
...
label variable ECITIZEN "PE: US Citizenship Status of Respondent";
label variable EMS "PE: Marital status";
label variable ERACE "PE: The race(s) the respondent is";
label variable TMOVRFLG "PE: Mover flag";
...
label variable EMOONLIT "LF: Additional work";
...
label variable SSUID "SU: Sample Unit Identifier";
label values TPEARN FM0X;
label values RWKESR1 FM1X;
label values RWKESR2 FM2X;
label values RWKESR3 FM3X;
label values RWKESR4 FM4X;
label values RWKESR5 FM5X;
label values RMHRSWK FM6X;
label values ESEX FM10X;
label values TAGE FM12X;
label values EBORNUS FM15X;
label values ECITIZEN FM16X;
label values EMS FM17X;
label values ERACE FM18X;
label values TMOVRFLG FM19X;
label values RHCALMN FM20X;
label values RMESR FM22X;
label values RMWKWJB FM23X;
label values RWKSPERM FM24X;
label values SPANEL FM25X;
label values SREFMON FM26X;
label values RMWKLKG FM27X;
label values RMWKSAB FM28X;
label values RNOTAKE FM29X;
label values RTAKJOB FM30X;
label values TSTOTINC FM33X;
label values EORIGIN FM35X;
label values EPNSPOUS FM36X;
label values EPPINTVW FM37X;
label values ESFNP FM39X;
label values TPTOTINC FM40X;
label values EABRE FM41X;
label values EAWOP FM42X;
label values EJOBCNTR FM43X;
label values ELAYOFF FM44X;
label values ELKWRK FM45X;
label values EMAX FM46X;
label values EMOONLIT FM47X;
label values EPDJBTHN FM48X;
label values EPTRESN FM49X;
label values EPTWRK FM50X;
label values ERSNOWRK FM51X;

save "wave9_2.dta",
replace;
describe;

merge 1:1 SSUID SREFMON EPPPNUM using "wave9_1.dta";
