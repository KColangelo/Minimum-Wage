...
append using "long_2004.dta"
save "long_2004",replace
}
...
zipfile long_2004.dta wave*.dta, saving(waves_unemp)

local filelist wave1.dta wave2.dta wave3.dta wave4.dta wave5.dta wave6.dta wave7.dta wave8.dta wave9.dta wave10.dta wave11.dta wave12.dta long_2004.dta
